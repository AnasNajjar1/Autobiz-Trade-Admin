  ...
  return (
    ...
    >
      {permission => [
        ...
        <Resource name="others" list={AuctionFinished} icon={DirectionsCar} />,
        <Resource name="others" list={AuctionFailed} icon={DirectionsCar} />,
        <Resource name="others" list={PurchasedImmediately} icon={DirectionsCar} />,
        <Resource name="others" list={Sold} icon={DirectionsCar} />,
